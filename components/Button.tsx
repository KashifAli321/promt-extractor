...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 shadow-lg shadow-indigo-500/20 focus:ring-indigo-500 border border-transparent",
    secondary: "text-slate-200 bg-slate-800 hover:bg-slate-700 border border-slate-700 focus:ring-slate-500",
